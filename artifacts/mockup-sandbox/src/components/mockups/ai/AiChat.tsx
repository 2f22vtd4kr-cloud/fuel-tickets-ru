...
const DEMO_HISTORY: Msg[] = [
  ...
  {
    role: "bot",
    text: "🤖 Привет! Я — **КризисБот**, ИИ-советник по топливу.\n\nСистема сейчас: 1000+ АЗС по всей России (Крым, Москва, регионы).\n\nЧем могу помочь:\n• 📍 Поиск АЗС по городу или сети\n• 💰 Цены и расчёт бюджета\n• 🎫 Покупка топливных талонов\n• 📊 Кризисный прогноз по регионам\n\nПросто спроси!",
    suggestions: ["Найти АЗС рядом", "Купить талон", "Прогноз кризиса"],
  },
  { role: "user", text: "А по мск?" },
  {
    role: "bot",
    text: "**Москва** теперь в системе! 🎉\n\nУ нас **140+ АЗС** в Москве и Новой Москве — Газпромнефть, Лукойл, Роснефть, Татнефть и другие.\n\nВсего в системе: **1000+ станций** по всей России.\n\nФильтруй карту: выбери регион «г. Москва и Новая Москва».",
