...
const ICONS: Record<TabId, (active: boolean) => React.ReactNode> = {
  map: (a) => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={a ? "#a855f7" : "#4b5563"} strokeWidth={a ? 1.9 : 1.5} strokeLinecap="round" strokeLinejoin="round">
...
const TABS: { id: TabId; label: string; emoji: string }[] = [
  ...
  { id: "analytics", label: "Данные",  emoji: "📊" },
  { id: "catalog",   label: "Каталог", emoji: "⛽" },
  { id: "vault",     label: "Сейф",    emoji: "🔐" },
  { id: "reserve",   label: "Фортуна", emoji: "⭐" },
];
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        height: "1px",
        background: "linear-gradient(90deg, transparent, rgba(168,85,247,0.35), rgba(219,39,119,0.35), transparent)",
        pointerEvents: "none",
      }} />
        ...
        return (
          ...
          >
            ...
            {isActive && (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: "0 0 12px #a855f799, 0 0 24px #a855f744",
                }}
            ...
            <div style={{ position: "relative", lineHeight: 1 }}>
              <motion.div
                animate={{
                  ...
                  filter: isActive
                    ? "drop-shadow(0 0 7px rgba(168,85,247,0.65))"
                    : "none",
                }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "2px" }}>
              <span style={{ fontSize: "0.6rem", lineHeight: 1, opacity: isActive ? 1 : 0.55 }}>
                {tab.emoji}
              </span>
              <motion.span
                animate={{
