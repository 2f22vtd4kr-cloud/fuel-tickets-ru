...
const STEPS = [
  ...
  },
  {
    ...
    tab: "map",
    title: "Карта АЗС",
    desc: "570+ станций на интерактивной карте. Цвет маркера — уровень доступности: 🟢 есть, 🟡 мало, 🔴 нет. Нажмите на станцию для подробностей.",
    cta: "Дальше →",
    color: "#06b6d4",
  ...
  },
  {
    ...
    desc: "Региональные графики запасов, тренды за 24 часа и сводка по ценам. Следите за дефицитом ещё до его начала.",
    cta: "Дальше →",
    color: "#22c55e",
