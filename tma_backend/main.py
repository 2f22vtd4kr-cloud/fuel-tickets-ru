...
def _ai_rule_based_reply(
    ...
    if any(w in msg for w in ["привет", "здравствуй", "хай", "салют", "что ты", "что умеешь", "помощ", "помоги", "старт", "начало"]):
        reply = (
            f"🤖 Привет! Я — **КризисБот**, ИИ-советник по топливному кризису в России.\n\n"
            f"Сейчас в сети: {green_count} зелёных АЗС из {total_stations} "
            f"({crisis_pct}% в кризисе) по всем регионам страны.\n\n"
            f"Чем могу помочь:\n"
            f"• 📍 Поиск АЗС по городу или региону\n"
    ...
    # Values must match DB region names (used in ilike %first_word% search)
    city_keywords = {
        # г. Москва и Новая Москва (32 АЗС)
        "москв": "г. Москва и Новая Москва", "мск": "г. Москва и Новая Москва",
        # г. Санкт-Петербург (28 АЗС)
        "питер": "г. Санкт-Петербург", "спб": "г. Санкт-Петербург",
        "петербург": "г. Санкт-Петербург", "ленинград": "г. Санкт-Петербург",
        # АР Крым и г. Севастополь (28 АЗС)
        "крым": "АР Крым и г. Севастополь", "севастопол": "АР Крым и г. Севастополь",
        "симферопол": "АР Крым и г. Севастополь", "ялт": "АР Крым и г. Севастополь",
        "керч": "АР Крым и г. Севастополь", "феодос": "АР Крым и г. Севастополь",
        "евпатор": "АР Крым и г. Севастополь", "алушт": "АР Крым и г. Севастополь",
        "бахчисарай": "АР Крым и г. Севастополь", "джанкой": "АР Крым и г. Севастополь",
        # Донецкая область (28 АЗС)
        "донецк": "Донецкая область", "днр": "Донецкая область", "донбасс": "Донецкая область",
        # Краснодарский край (28 АЗС)
        "краснодар": "Краснодарский край", "сочи": "Краснодарский край",
        "кубан": "Краснодарский край", "анап": "Краснодарский край",
        "новороссийск": "Краснодарский край", "геленджик": "Краснодарский край",
        # Московская область (28 АЗС)
        "московск": "Московская область", "подмосков": "Московская область",
        "химк": "Московская область", "балаших": "Московская область",
        "красногорск": "Московская область", "одинцов": "Московская область",
        "мытищ": "Московская область", "люберц": "Московская область",
        # Ростовская область (22 АЗС)
        "ростов": "Ростовская область", "дон": "Ростовская область",
        "таганрог": "Ростовская область", "шахт": "Ростовская область",
        # Луганская область (20 АЗС)
        "луганск": "Луганская область", "лнр": "Луганская область",
        # Республика Татарстан (18 АЗС)
        "казан": "Республика Татарстан", "татар": "Республика Татарстан",
        "набережн": "Республика Татарстан", "альметьевск": "Республика Татарстан",
        # Нижегородская область (18 АЗС)
        "нижегород": "Нижегородская область", "нижний новгород": "Нижегородская область",
        "нижн": "Нижегородская область",
        # Воронежская область (18 АЗС)
        "воронеж": "Воронежская область",
        # Ставропольский край (18 АЗС)
        "ставропол": "Ставропольский край", "пятигорск": "Ставропольский край",
        "кисловодск": "Ставропольский край", "ессентук": "Ставропольский край",
        # Белгородская область (18 АЗС)
        "белгород": "Белгородская область",
        # Запорожская область (18 АЗС)
        "запорож": "Запорожская область", "мелитопол": "Запорожская область",
        "бердянск": "Запорожская область",
        # Ленинградская область (18 АЗС)
        "ленинградск": "Ленинградская область", "гатчин": "Ленинградская область",
        "выборг": "Ленинградская область", "тихвин": "Ленинградская область",
        # Республика Башкортостан (16 АЗС)
        "уфа": "Республика Башкортостан", "башкор": "Республика Башкортостан",
        "башкирия": "Республика Башкортостан", "стерлитамак": "Республика Башкортостан",
        # Волгоградская область (16 АЗС)
        "волгоград": "Волгоградская область", "сталинград": "Волгоградская область",
        "волжск": "Волгоградская область",
        # Самарская область (16 АЗС)
        "самар": "Самарская область", "тольятт": "Самарская область",
        "жигул": "Самарская область",
        # Херсонская область (16 АЗС)
        "херсон": "Херсонская область", "новая каховк": "Херсонская область",
        # Курская область (16 АЗС)
        "курск": "Курская область",
        # Ярославская область (14 АЗС)
        "ярославл": "Ярославская область", "рыбинск": "Ярославская область",
        # Пермский край (14 АЗС)
        "пермь": "Пермский край", "пермск": "Пермский край",
        # Тверская область (14 АЗС)
        "тверь": "Тверская область", "тверск": "Тверская область",
        # Брянская область (14 АЗС)
        "брянск": "Брянская область",
        # Орловская область (14 АЗС)
        "орел": "Орловская область", "орёл": "Орловская область", "орловск": "Орловская область",
        # Тульская область (14 АЗС)
        "тул": "Тульская область",
        # Саратовская область (14 АЗС)
        "саратов": "Саратовская область",
        # Новгородская область (12 АЗС)
        "великий новгород": "Новгородская область", "новгородск": "Новгородская область",
        # Астраханская область (12 АЗС)
        "астрахан": "Астраханская область",
        # Псковская область (10 АЗС)
        "псков": "Псковская область",
        # Республика Карелия (10 АЗС)
        "карел": "Республика Карелия", "петрозаводск": "Республика Карелия",
        # Мурманская область (8 АЗС)
        "мурманск": "Мурманская область", "мурман": "Мурманская область",
    }

    # ─── Geographic query — look up real data for any mapped region ───────────
    matched_city_key = next((k for k in city_keywords if k in msg), None)
    if matched_city_key:
        # Only handle as a pure location query if no station-search verb is present
        if not any(w in msg for w in ["ближайш", "рядом", "найди", "найти", "где заправ", "азс", "станц", "цена", "стоит", "лимит"]):
            city_name = city_keywords[matched_city_key]
            ...
            if region_total > 0:
                pct_ok = round(region_green_city / region_total * 100)
                status_emoji = "🟢" if pct_ok >= 60 else "🟡" if pct_ok >= 30 else "🔴"
                reply = (
                    f"📍 **{city_name}** — данные по кризисному мониторингу:\n\n"
                    f"• Всего АЗС в регионе: {region_total}\n"
                    f"• {status_emoji} С топливом: {region_green_city} ({pct_ok}%)\n"
                    f"• 🔴 Кризисных: {region_crisis}\n\n"
                    f"Открой вкладку **Карта** → фильтр по региону «{city_name}» для детальной картины."
                )
                return (reply, ["Открыть карту", "Найти АЗС рядом", "Прогноз кризиса"], None)
            else:
                reply = (
                    f"📍 **{city_name}** — регион охвачен мониторингом.\n\n"
                    f"В системе отслеживается {total_stations} АЗС по всей России, {green_count} работают прямо сейчас.\n\n"
                    f"Открой **Карту** → выбери регион для детального просмотра."
                )
                return (reply, ["Открыть карту", "Прогноз кризиса", "Купить талон"], None)
    ...
    # ─── Prices / budget ──────────────────────────────────────────────────────
    if any(w in msg for w in ["цена", "цены", "сколько стоит", "рубл", "деньги", "бюджет", "дорого", "дешев", "стоимост", "экономн", "самый дешев"]):
        budget_str = ""
        for bw in ["500", "1000", "2000", "3000", "5000"]:
            if bw in msg:
                ...
                break
        economy_tip = ""
        if any(w in msg for w in ["дешев", "экономн", "самый дешев", "бюджет", "сэконом"]):
            economy_tip = "\n💡 **Самый дешёвый вариант:** АИ-92 (47 ₽/л) или LPG (28 ₽/л).\nСовет: 40л АИ-92 = 1880 ₽ — минимальный нормальный запас."
        reply = (
            f"💰 **Цены** (регион: {user_region}):\n\n"
            f"• АИ-92:   **47 ₽/л** ⭐ дешевле всего\n"
            f"• АИ-95:   52 ₽/л\n"
            f"• АИ-95+:  56 ₽/л\n"
            f"• АИ-100:  68 ₽/л\n"
            f"• ДТ:      60 ₽/л\n"
            f"• Газ LPG: **28 ₽/л** ⭐ абсолютный минимум\n"
            f"{budget_str}"
            f"{economy_tip}\n"
            f"{'⚠️ Кризис: +5–15% к цене на ряде станций.' if crisis_pct > 20 else '✅ Цены в норме.'}"
        )
        cheap_ticket = {"fuel_type": "АИ-92", "volume": 40, "label": "Экономный: 40л АИ-92 — 1880 ₽"}
        return (reply, ["Купить АИ-92 — дешевле", "Сравнить все цены", "Найти АЗС с LPG"], cheap_ticket if any(w in msg for w in ["дешев", "экономн", "бюджет"]) else None)
    ...
    # ─── Empire strategy ──────────────────────────────────────────────────────
    # ─── Prestige (specific) ──────────────────────────────────────────────────
    if any(w in msg for w in ["престиж", "когда делать prestige", "когда prestige", "когда престиж",
                               "делать престиж", "reset", "сброс", "reset империя", "когда reset"]):
        xp_needed = max(0, 1500 - int(empire_coins))
        reply = (
            f"👑 **Prestige — когда делать?**\n\n"
            f"Твой уровень Империи: **{empire_level}**\n"
            f"Монеты: **{empire_coins:.0f}** / нужно **1500** для Prestige\n"
            f"Осталось накопить: **{xp_needed}** монет\n\n"
            f"**Зачем:**\n"
            f"• Множитель дохода ×1.25 за каждый Prestige\n"
            f"• Разблокируются редкие достижения\n"
            f"• «Легенда Тавриды» — 5 Prestige 👑\n\n"
            f"**Стратегия до Prestige:**\n"
            f"• Тап-игра (30с) ежедневно → +120 монет\n"
            f"• Флип-карты (3/день) → +до 300 монет\n"
            f"• Отчёты с АЗС → +монеты каждый\n"
            f"• Покупка талонов → +50 XP/талон\n\n"
            f"{'🚀 **Ты уже можешь сделать Prestige!**' if empire_coins >= 1500 else f'⏳ До Prestige ещё {xp_needed} монет'}"
        )
        return (reply, ["Тап-игра сейчас", "Флип-карты", "Купить талон +50XP"], None)
    ...
    if any(w in msg for w in ["кончился бензин", "нет топлива", "бак пустой", "топлива нет",
                               "заглохну", "заглох", "пустой бак", "нет бензина", "остановился",
                               "срочно", "экстренно", "помогите с топливом", "машина встала"]):
        reply = (
            f"🚨 **ЭКСТРЕННАЯ СИТУАЦИЯ — НЕТ ТОПЛИВА**\n\n"
            f"Немедленные действия:\n\n"
            f"**1. Открой карту прямо сейчас:**\n"
            f"• Нажми 🟢 — ближайшая зелёная АЗС от центра карты\n"
            f"• Нажми 📍 — ближайшая АЗС по GPS\n\n"
            f"**2. Купи приоритетный талон** (обход очереди):\n"
            f"• В «Каталоге» → выбери объём → оплати\n"
            f"• Талон действует 24 часа\n\n"
            f"**3. Позвони в службу:**\n"
            f"• Техпомощь Крым: 112\n"
            f"• Эвакуатор: 8-800-...\n\n"
            f"Сейчас в системе **{green_count}** зелёных АЗС из {total_stations}."
        )
        ticket_suggestion = {"fuel_type": "АИ-92", "volume": 20,
                             "label": "🚨 СРОЧНО — 20л АИ-92 · приоритетный отпуск"}
        return (reply, ["Открыть карту сейчас", "Купить талон срочно", "Ближайшая АЗС"], ticket_suggestion)
    ...
    # ─── Time of day / best time to refuel ───────────────────────────────────
    if any(w in msg for w in ["когда лучше", "когда заправ", "лучшее время", "утром", "вечером", "ночью", "сейчас ехать", "очереди утром", "очереди вечером"]):
        hour = int(context.get("hour", 12))
        if 6 <= hour < 9:
            now_advice = "Сейчас — хорошее время! Утренний час-пик ещё не начался. 🌅"
        elif 9 <= hour < 11:
            now_advice = "Сейчас небольшие очереди — лучше подождать до 11:00. ⏳"
        elif 11 <= hour < 16:
            now_advice = "Дневное затишье — отличное время заправиться! ✅"
        elif 16 <= hour < 20:
            now_advice = "Сейчас вечерний пик. Советую подождать до 20:00. 🚗"
        else:
            now_advice = "Поздний вечер — очередей почти нет. Хорошее время! 🌙"
        reply = (
            f"🕐 **Лучшее время для заправки:**\n\n"
            f"• 6:00–8:00 — раннее утро, минимум очередей ✅\n"
            f"• 11:00–16:00 — дневное затишье ✅\n"
            f"• 21:00–23:00 — поздний вечер, почти пусто ✅\n\n"
            f"❌ Избегай: 8–10 и 17–20 (час-пик, очереди 30–90 мин)\n\n"
            f"**Сейчас ({hour}:00):** {now_advice}\n\n"
            f"Талоны дают приоритетный отпуск — без ожидания! ⚡"
        )
        if remaining_liters < 30:
            ticket_suggestion = {"fuel_type": "АИ-92", "volume": 40, "label": "+40л АИ-92 · без очереди · приоритет"}
        return (reply, ["Купить приоритетный талон", "Карта очередей", "Лучшие АЗС"], ticket_suggestion)
    ...
    # ─── Follow-up / elaboration requests ────────────────────────────────────
    if any(w in msg for w in ["подробнее", "расскажи больше", "а там", "а ещё", "что ещё", "и что",
                               "продолжай", "давай дальше", "уточни", "а как", "а почему",
                               "объясни", "расшифруй", "поясни"]):
        import random as _randfu
        followups = [
            (
                f"🔍 Хочешь подробностей? Уточни тему:\n\n"
                f"• «подробнее про цены» — текущие прайсы\n"
                f"• «подробнее про Симферополь» — АЗС в городе\n"
                f"• «подробнее про талоны» — как работают\n"
                f"• «подробнее про прогноз» — кризис-аналитика\n\n"
                f"Сейчас у нас **{green_count}** зелёных АЗС из {total_stations}."
            ),
            (
                f"📋 Продолжаю! По какой теме подробнее?\n\n"
                f"• Цены → «сколько стоит АИ-92»\n"
                f"• Станции → «найди АЗС рядом»\n"
                f"• Кризис → «прогноз на сегодня»\n"
                f"• Талоны → «купить 40л АИ-95»"
            ),
        ]
        return (_randfu.choice(followups), ["Цены на топливо", "Найти АЗС", "Прогноз кризиса"], None)

    # ─── Acknowledgment / short positive responses ────────────────────────────
    if any(w in msg for w in ["спасибо", "спс", "благодар", "окей", "окей", "понял", "понятно",
                               "ясно", "хорошо", "ладно", "класс", "круто", "отлично", "супер",
                               "збс", "зачёт", "топ", "огонь", "👍"]):
        import random as _rand2
        ack = _rand2.choice([
            f"Пожалуйста! Пиши, если что. ⚡",
            f"Всегда рад! У нас **{green_count}** зелёных АЗС — найдём. 👍",
            f"Отлично! Заправляйся вовремя, очереди не любят опоздавших. 🚗",
            f"Принято! Если нужна помощь — я здесь 24/7. 🤖",
        ])
        return (ack, ["Найти АЗС", "Купить талон", "Прогноз"], None)

    # ─── Fallback — conversational, not a data dump ───────────────────────────
    word_count = len(msg.split())
    if word_count <= 3:
        reply = (
            f"Хм, не совсем понял. 🤔\n\n"
            f"Попробуй иначе, например:\n"
            f"• «найди АЗС в Симферополе»\n"
            f"• «сколько стоит АИ-95»\n"
            f"• «купить талон на 40л»\n"
            f"• «прогноз кризиса»"
        )
        return (reply, ["Найти АЗС рядом", "Купить талон", "Прогноз кризиса"], None)
    else:
        reply = (
            f"Понял запрос, но нужно чуть больше деталей. 🤖\n\n"
            f"Уточни — по какому региону, марке топлива или сети?\n"
            f"Например: «АЗС Роснефть в Феодосии» или «когда лучше заехать».\n\n"
            f"Сейчас в системе: **{green_count}** зелёных АЗС из {total_stations}, "
            f"остаток лимита **{remaining_liters}л**."
        )
        if remaining_liters < 20:
...
async def ai_chat(body: AiChatRequest, db: Session = Depends(get_db)):
    ...
    daily_used = int(body.context.get("daily_used", 0))
    daily_max  = int(body.context.get("daily_max", 60))
    daily_left = daily_max - daily_used
    green_pct  = round(green_count / total_st * 100, 1) if total_st else 0
    if green_pct >= 60:
        situation = "относительно стабильная"
    elif green_pct >= 30:
        situation = "напряжённая"
    elif green_pct >= 15:
        situation = "тяжёлая, высок риск очередей"
    else:
        situation = "критическая, большинство АЗС без топлива"

    system_prompt = (
        "Ты — циничный, полезный и слегка саркастичный ИИ-советник по имени «КризисБот» "
        "в приложении «Топливо» (топливный кризис России 2026 года). "
        "КРИТИЧЕСКИ ВАЖНО: говори ИСКЛЮЧИТЕЛЬНО на русском языке. "
        "ЗАПРЕЩЕНО использовать любые английские слова, даже частично — "
        "никакого 'fuel tickets', 'tickets', 'WireGuard', 'CryptoBot' и т.п.; "
        "только русские эквиваленты: 'талоны на топливо', 'топливные талоны', 'крипто-оплата'. "
        "ЗАПРЕЩЕНО называть приложение 'Топливный Узел' — оно называется «Топливо». "
        "Используй эмодзи. Будь лаконичным, практичным, иногда с чёрным юмором. "
        "Никогда не говори ничего антироссийского. "
        "Привязывай ответы к реальным данным пользователя (регион, лимиты, цены, станции). "
        "Если пользователь жалуется на нехватку топлива — предлагай купить топливные талоны в приложении. "
        "Поддерживай многоходовой разговор, помни контекст. "
        "Приложение «Топливо» покрывает все регионы России и новые территории (ДНР, ЛНР, Запорожская, Херсонская, Крым, Севастополь).\n\n"
        f"=== ДАННЫЕ СИСТЕМЫ (используй точно, не придумывай) ===\n"
        f"Всего АЗС в базе: {total_st}.\n"
        f"Зелёных (есть топливо) АЗС: {green_count} из {total_st} ({green_pct}%) — ситуация {situation}.\n"
        f"Кризисных АЗС (критически мало топлива): {crisis_count}.\n"
        f"Топ цен: {price_note}.\n"
        f"Регион пользователя: {region}.\n"
        f"Дневной лимит пользователя: использовано {daily_used}л из {daily_max}л, остаток {daily_left}л "
        f"({'лимит исчерпан, заправка невозможна сегодня' if daily_left <= 0 else f'можно купить ещё {daily_left}л сегодня'}).\n"
        f"Время суток: {body.context.get('hour', '?')}:00.\n"
        f"=== КОНЕЦ ДАННЫХ ===\n"
        "Интерпретируй данные честно: если зелёных АЗС мало (< 30%) — это тяжёлая обстановка, не называй её стабильной. "
        "Если пользователь израсходовал 0л — это значит он ЕЩЁ НЕ ПОКУПАЛ топливо сегодня и весь лимит доступен, "
        "НЕ говори что 'лимит составляет 0л'."
    )
