...
def _ai_rule_based_reply(
    ...
    city_keywords = {
        ...
        # Санкт-Петербург
        "питер": "Санкт-Петербург", "спб": "Санкт-Петербург", "ленинград": "Санкт-Петербург",
        # Крым и Севастополь
        "крым": "Крым", "севастопол": "Севастополь", "симферопол": "Симферополь",
        "ялт": "Ялта", "керч": "Керчь", "феодос": "Феодосия", "евпатор": "Евпатория",
        "алушт": "Алушта", "бахчисарай": "Бахчисарай", "джанкой": "Джанкой",
        # Новые территории
        "донецк": "Донецкая область", "днр": "Донецкая область",
        ...
        "нижн": "Нижегородская область", "нижний": "Нижегородская область",
        "самар": "Самарская область",
        "саратов": "Саратовская область",
        "уфа": "Республика Башкортостан", "башкор": "Республика Башкортостан", "башкирия": "Республика Башкортостан",
        "пермь": "Пермский край",
        # Урал и Сибирь
        "екатеринбург": "Екатеринбург", "свердловск": "Екатеринбург",
        "челябинск": "Челябинск",
        "омск": "Омск",
    ...
    if matched_city_key:
        ...
        if not any(w in msg for w in ["ближайш", "рядом", "найди", "найти", "где заправ", "азс", "станц", "цена", "стоит", "лимит"]):
            ...
            if region_total > 0:
                ...
                reply = (
                    f"📍 **{city_name}** — данные по Матрице Снабжения:\n\n"
                ...
                reply = (
                    f"📍 **{city_name}** — регион есть в Матрице Снабжения.\n\n"
                    f"Системой охвачено {total_stations} АЗС по всей России, {green_count} работают прямо сейчас.\n\n"
